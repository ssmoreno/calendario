...
CREATE TABLE "user_settings" (
    ...
    "defaultColor" TEXT NOT NULL DEFAULT 'coral',
...
-- CreateTable
CREATE TABLE "eve_session_owner" (
    "sessionId" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "eve_session_owner_pkey" PRIMARY KEY ("sessionId")
);
...
-- CreateIndex
CREATE INDEX "user_memory_userId_createdAt_idx" ON "user_memory"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "eve_session_owner_userId_idx" ON "eve_session_owner"("userId");
